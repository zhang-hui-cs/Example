...
bool HelloTexture::CreateVertexShader()
{
	const char* source = FileReader::ReadFile(".\\HelloTexture\\vertex.shader");

	return this->CreateVertextShaderInternal(this->_vertexShader, source);
}

bool HelloTexture::CreateFragmentShader()
{
	const char* source = FileReader::ReadFile(".\\HelloTexture\\fragment.shader");
